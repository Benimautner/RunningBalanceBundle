...
namespace KimaiPlugin\RunningBalanceBundle\EventSubscriber;
...
final class ReportingSubscriber implements EventSubscriberInterface
{
    ...
    public function onReporting(ReportingEvent $event): void
    {
        ...
        $event->addReport(new Report('runningbalance_report', 'runningbalance_report', 'Running Balance report', 'fas fa-chart-simple'));
    }
}
